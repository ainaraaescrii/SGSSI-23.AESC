...
def proof_mas_larga_un_min(contenido_original, tiempo_maximo=60):
    ...
    while time.time() - inicio_tiempo < tiempo_maximo:
        secuencia_hex = format(proof, '08x')
        contenido_con_proof = f"{contenido_original}{secuencia_hex}\t7c\t100"
        resumen_sha256 = calc_sha256(contenido_con_proof)
...
archivo_entrada =  '/Users/ainaraaescrii/Desktop/CUARTO/SGSSI/Tareas/S6/SGSSI-23.CB.03.txt'
archivo_salida = '/Users/ainaraaescrii/Desktop/CUARTO/SGSSI/Tareas/S6/SGSSI-23.CB.03.7c.txt'
